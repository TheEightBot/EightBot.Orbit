...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        public static IServiceCollection AddSyncControllers(this IServiceCollection services, Action<OrbitSyncControllerFeatureProvider> config)
        {
        ...
        public static IServiceCollection AddDefaultSyncCosmosDataClient(this IServiceCollection services, string databaseUri, string authKey, string databaseId, Action<IDataClient> config, bool throwErrors = true, int? throughput = 400)
        {
